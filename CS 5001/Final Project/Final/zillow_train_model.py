...
def zillow_train_model(epochs, image_target_size, validation_split):
    ...
    data = pd.read_csv("/Users/michaelmills/Zillow_Dataset/zillow.csv", names=["photo_url", "price", "beds", "baths", "sqft", "doz", "zpid"])
    ...
    model.save("/Users/michaelmills/Saved_Models/zillow_model")
